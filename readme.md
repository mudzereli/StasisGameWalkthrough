...
###### Overgrown Oxygen Room
1. **USE** the **VAPORIZED QUEEN PHEROMONE** on the **FAST SPINNING FAN** to disperse the insects
2. **CLICK** each of 3 **OXYGEN COLLECTION TANK** in the room

###### Overgrown Pool
1. **CLICK** the **BODY ENGULFED IN VINES** to obtain **EMERGENCY FLARE**
2. **EXIT** to the **BOTTOM RIGHT**

###### Elanore's Room
1. **CLICK** on **ELANORE WAY** to activate a dialog
2. **USE** the **EMERGENCY FLARE** on **ELANORE WAY**
3. after this scene you will automatically run to the **Botany Lab**

###### Botany Lab
1. **GO BACK** to the **Botany Elevator Room**

###### Botany Elevator Room
1. **EXIT** using the **ELEVATOR**

<sub><sup>[<- Back to Index](#index)</sup></sub>

<sub><sup>[-> Chapter 10: The Power Lab](#chapter-10-power-lab)</sup></sub>

-------------------------------------------------------------------------------

#### CHAPTER 10: POWER LAB

###### Power Room Elevator
1. **CLICK** the **TOOLBOX** near the **ELEVATOR** to obtain **HIGH TEMPERATURE SLUG GUN**
2. **EXIT** to the **BOTTOM LEFT**

###### Power Hallway Hub
1. avoid the robot in this hallway
2. **EXIT** on the **TOP LEFT** into the **BIRTHING LABORATORY**

###### Birthing Laboratory
1. **PICK UP** the **PORTABLE DEFRIBRILLATOR** on the **RIGHT** side of the room
2. **CLICK** on the **BOTTOM LEFT** **PREGNANT WOMAN** to get **BANDAGE**
3. **GO BACK** to the **Power Hallway Hub**

###### Power Hallway Hub
1. avoid the robot in this hallway
2. **EXIT** on the **RIGHT** into the **MUTAGEN LABORATORY**

###### Mutagen Laboratory
1. **PICK UP** the **LIQUID NITROGEN CANISTER** near the **BOTTOM** of the screen
2. **GO BACK** to the **Power Hallway Hub**

###### Power Hallway Hub
1. **USE** the **BANDAGE** on the nearby **SINK** to clog it
2. **USE** the **SINK** again to flood the floor
3. wait for the robot to get on the water then **USE** the **PORTABLE DEFRIBRILLATOR** on the **SPILLED WATER**
4. **CLICK** the **DEACTIVATED SENTRY ROBOT** to obtain **TWISTED METAL**
5. **CLICK** the **PLATFORM** near the **BOTTOM LEFT** to go up to the walkway
6. **USE** the **LIQUID NITROGEN CANISTER** on the red **AIRLOCK**
7. **USE** the **HIGH TEMPERATURE SLUG GUN** on the **AIRLOCK** to blast it open
8. **EXIT** through the newly opened hole in the walkway
...
<sub><sup>[-> Chapter 12: Visitor's Center](#chapter-12-visitors-center)</sup></sub>
